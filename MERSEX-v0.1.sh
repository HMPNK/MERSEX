...
pigz -dc FINAL-table.gz | parallel --keep-order -j 16 -l 1000000 --pipe 'mawk -v cmin=2 -v fcount=$FCOUNT -f count.samples.awk - ' | pigz -c > FINAL-table.sample-counts-cmin2.gz
